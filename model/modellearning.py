...
# >> 이루어져있고, 1 ~ 10점까지의 평점 중 중립적인 평점(5 ~ 8점)은
...
import os
import nltk
import matplotlib.pyplot as plt  #그래픽 그릴 때 쓰는 것임
import numpy as np  #행렬 도구
...
# nsmc 데이터를 불러와서 불러와서 python 변수에 담기
